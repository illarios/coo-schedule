  ...
  return (
    <div className="phone-shell flex flex-col items-center justify-center min-h-screen px-6 bg-coo-paper">
      ...
      >
        ...
        <p className="font-archivo text-lg text-coo-black mb-2">Χωρίς σύνδεση</p>
        <p className="font-dm text-sm text-coo-black/55 mb-6 leading-relaxed">
          Δεν υπάρχει σύνδεση στο διαδίκτυο. Έλεγξε το WiFi ή τα δεδομένα σου και δοκίμασε ξανά.
        </p>
        <button
      ...
      <p className="mt-8 font-dm text-xs text-coo-black/40">Πτολεμαΐδα · Περδίκα 4</p>
    </div>
  );
}
